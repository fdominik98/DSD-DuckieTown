...
class HumanDriver:
    ...
    def update(self, dt, env):
        ...
        if round(self.joystick.ry, 2) == 0.0 and round(self.joystick.y, 2) == 0.0:
            return

        #! Nominal Joystick Interpretation
        x = round(self.joystick.ry, 2) * 0.9  # To ensure maximum trun/velocity ratio
        z = round(self.joystick.hat_x, 2) * 3.0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--map-name", default="MyMap")
    ...
    parser.add_argument("--logfile", type=str, default="humandataset.log")
